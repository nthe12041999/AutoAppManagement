...
{
    public interface ICustomerDeviceRepository : IBaseRepository<CustomerDevice>
    {
        /// <summary>
        ...
        Task<IEnumerable<CustomerDevice>> GetDevicesByAccountId(long accountId);
        ...
        Task<CustomerDevice> GetDeviceByDeviceIdAndAccountId(string deviceId, long accountId);
        ...
        Task<CustomerDevice> GetPrimaryDevice(long accountId);
        ...
        Task<IEnumerable<CustomerDevice>> GetActiveDevices(long accountId);
    ...
    public class CustomerDeviceRepository
        : BaseRepository<CustomerDevice>,
            ICustomerDeviceRepository
    {
        public CustomerDeviceRepository(AutoAppManagementContext context)
            : base(context) { }

        public async Task<IEnumerable<CustomerDevice>> GetDevicesByAccountId(long accountId)
        {
            return await FindBy(d => d.AccountId == accountId);
        }

        public async Task<CustomerDevice> GetDeviceByDeviceIdAndAccountId(
            string deviceId,
            long accountId
        )
        {
        ...
        public async Task<CustomerDevice> GetPrimaryDevice(long accountId)
        {
        ...
        public async Task<IEnumerable<CustomerDevice>> GetActiveDevices(long accountId)
        {
