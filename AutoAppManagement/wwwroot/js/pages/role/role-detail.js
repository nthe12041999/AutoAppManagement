    ...
    ensureBaseDetailReady(function () {
        ...
        class RoleDetail extends window.BaseDetail {
            onInit() {
                ...
                // Global permission helper functions
                window.selectAllPermissions = function() { 
                    ...
                    if (window.formControlBinder && typeof window.formControlBinder.showNotification === 'function') {
                        window.formControlBinder.showNotification('Đã chọn tất cả quyền hạn', 'success'); 
                    }
                };
                ...
                window.clearAllPermissions = function() { 
                    ...
                    if (window.formControlBinder && typeof window.formControlBinder.showNotification === 'function') {
                        window.formControlBinder.showNotification('Đã bỏ chọn tất cả quyền hạn', 'info'); 
                    }
                };
            }
